...
export class ThumbnailGenerator {
  static async enhancePrompt(userPrompt) {
  ...
  static async generateFromPrompt(prompt) {
    try {
      const enhancedPrompt = this.enhancePrompt(prompt, style);
        ...
        messages: [
          {
            ...
            Generate different variations with eye-catching designs, high contrast, and vibrant colors.`
          },
          {
            role: "user",
